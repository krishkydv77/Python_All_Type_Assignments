...
if monthName in ("january", "march", "may", "july", "august", "october", "december"):
    print('days 31,',monthName,year)
elif monthName in ("april", "june", "september", "november"):
    print('days 30,',monthName,year)
elif (monthName== "february"):
    if((year%4==0 and year%100!=0) or (year%400==0)):
        print('days 29,',monthName,year)
    else:
        print('days 28,',monthName,year)
...
if(option==1):
    ...
    print('successfully withdraw Amount =',withdraw)
    current_balance = balance - withdraw
    print('your balance =',current_balance)
else:
    print("try again")
